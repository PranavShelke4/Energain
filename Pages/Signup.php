...
<body>
    ...
    <!-- <section class="h-100 bg-dark" id="signupSection">
                        ...
                        <div class="row g-0">
                            <div class="col-xl-6">
                                <div class="card-body p-md-4 text-black">
                                    <h3 class="mb-5 text-uppercase d-flex justify-content-center align-items-center ">Signup form</h3>
                                    ...
                                    <form method="POST" action="">
                                        ...
                                        <div class="mb-4">
                                            <input type="password" id="form3Example97" name="cpassword"
                                        ...
                                        <p class="signupoption d-flex justify-content-center align-items-center">Alrady have an account? <a class="signupbtn" href="login.php"> Login</a></p>
                                    </form>
                            ...
                            <div class="col-xl-6 d-none d-xl-block right-side">
                                ...
                                alt="Sample photo" class="img-fluid imgg "
                                 />
                            </div>
                        </div>
                    </div>
