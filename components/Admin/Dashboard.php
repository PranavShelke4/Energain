            ...
            <table class="w-full bg-[#D9D9D9] border-collapse border border-slate-500">
                ...
                <tbody class="text-xl text-center font-normal">
                    ...
                    <tr>
                        ...
                        <td class="border border-slate-700 ...">8080054394</td>
                        <td class="border border-slate-700 ...">Male</td>
                        <td class="border border-slate-700 ...">Pune</td>
                    ...
                    <tr>
                        ...
                        <td class="border border-slate-700 ...">20</td>
                        <td class="border border-slate-700 ...">9875431123</td>
                        <td class="border border-slate-700 ...">Male</td>
                        <td class="border border-slate-700 ...">Pune</td>
